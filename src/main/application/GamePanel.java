...
public class GamePanel extends JPanel implements Runnable {
    ...
    public final int achievementState = 5;
...
//				delta--;
    ...
    private void updateParticles() {
        Iterator<Entity> iterator = particleList.iterator();
    ...
    private void drawToTempScreen() {
        ...
        // GAME START
            ...
            for (Entity t : iTile[currentMap]) {
                if (t != null && t.type == t.type_obstacle) {
                    entityList.add(t);
                }
            }
            for (Entity pr : projectile[currentMap]) {
                if (pr != null && !pr.grabbed) {
                    entityList.add(pr);
                }
            }
