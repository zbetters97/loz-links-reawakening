...
public class CollisionChecker {
    ...
    public void checkTile(Entity entity) {
        ...
        if (entity.thrown) {
            entityBottomWorldY = switch (entity.direction) {
                case "right", "left" -> {
                    entityTopWorldY = entity.tWorldY + entity.hitbox.y;
                    yield entity.tWorldY + entity.hitbox.y + entity.hitbox.height;
                }
                default -> entityBottomWorldY;
            };
        }
        ...
        // SPIKES
            ...
            if (entity == gp.player) {
                ...
                if (!gp.player.invincible) {
                    ...
                    String kbDirection = switch (entity.direction) {
                        case "up" -> "down";
                        case "down" -> "up";
                        case "left" -> "right";
                        case "right" -> "left";
        ...
        // OCEAN
            ...
            entity.collisionOn = entity.type != entity.type_projectile;
        }
        // NORMAL COLLISION
    ...
    public void checkHazard(Entity entity, boolean player) {
        ...
        switch (direction) {
            case "up":
                ...
                if (player && gp.player.onGround) {
                    checkSafeworld(tileNum1, tileNum2);
                }
    ...
    public void detectBounce(Entity entity) {
        ...
        switch (direction) {
            case "upleft":
                ...
                if (gp.tileM.tile[tileNum1].collision || gp.tileM.tile[tileNum1].water) {
                    entity.direction = "downleft";
                }
                else if (gp.tileM.tile[tileNum2].collision || gp.tileM.tile[tileNum2].water) {
    ...
    private void getBounce(Entity entity, Entity target, String direction) {
        ...
        if (entity.hitbox.intersects(target.hitbox)) {
            ...
            if (target.collision) {
                ...
                switch (direction) {
                    case "up":
                        if (entity.direction.equals("upleft")) {
                            entity.direction = "downleft";
                        }
                        else if (entity.direction.equals("upright")) {
                            entity.direction = "downright";
                        }
                        break;
                    case "down":
                        if (entity.direction.equals("downleft")) {
                            entity.direction = "upleft";
                        }
                        else if (entity.direction.equals("downright")) {
                            entity.direction = "upright";
                        }
                        break;
                    case "left":
                        ...
                        else if (entity.direction.equals("downleft")) {
                            entity.direction = "downright";
                        }
                        break;
                    case "right":
                        if (entity.direction.equals("upright")) {
                            entity.direction = "upleft";
                        }
                        else if (entity.direction.equals("downright")) {
                            entity.direction = "downleft";
